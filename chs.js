...
var cnItems = {
    ...
    "Hire a Common planter": "聘请普通种植园主",
    "Hire a Rare salesman": "聘请稀有推销员",
    "New pet found! Check the pets tab to see your new friend": "发现新宠物！ 检查宠物标签以查看您的新朋友",
    "Orange": "橙子",
    "Dark Logs": "黑暗原木",
    "Befriend Big ears to increase it's effect!": "结交大耳朵以增加它的效果！",
    "Sell some Basic Logs": "出售一些基础原木",
    "Apple Tree": "苹果树",
    "Achievement unlocked Skilled Trader": "成就解锁 熟练的交易员",
    "Apple Tree": "苹果树",
    "+ Limes": "+ 柠檬",
    "+ Peaches": "+ 桃子",
    "": "",
...
var cnPrefix = {
    ...
    "Peach": "桃子",
    " Tree": "树",
    "Achievement unlocked Good with animals Pt ": "成就解锁 与动物相处得很好 Pt ",
    "Friendship tier has increased! Big ears's friendship tier has increased to ": "友谊等级增加了！ 大耳朵的好感度提升到 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    "\n\t\t": "\n\t\t",
    "\t": "\t",
    " has been recruited!": " 被招募了！",
    " chance of double coins when selling items": " 出售物品时获得双倍硬币的几率",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^(.+) Marshas planted (.+) Basic Tree$/, '$1 玛莎 种了 $2 棵基础树'],
    [/^(.+) Steves planted (.+) Basic Tree$/, '$1 史蒂夫 种了 $2 棵基础树'],
    [/^(.+) Beth planted (.+) Basic Tree$/, '$1 贝丝 种了 $2 棵基础树'],
    [/^(.+) Claire planted (.+) Lemon Tree$/, '$1 克莱尔 种了 $2 棵柠檬树'],
    [/^(.+) Tom planted (.+) Lemon Tree$/, '$1 汤姆 种了 $2 棵柠檬树'],
    [/^(.+) Tom planted (.+) Lemon Trees$/, '$1 汤姆种了 $2 棵柠檬树'],
    [/^(.+) Broad Logs have been harvested$/, '$1 宽阔原木 已收获'],
    [/^(.+) Dark Logs have been harvested$/, '$1 黑色原木 已收获'],
    [/^(.+) Bushy Logs have been harvested$/, '$1 茂密原木 已收获'],
    ...
    [/^(.+) Peachs have been harvested$/, '$1 桃子 已收获'],
    [/^(.+) Limes have been harvested$/, '$1 酸橙 已收获'],
    [/^(.+) Basic Logs$/, '$1 基本原木'],
    [/^(.+) Broad Logs$/, '$1 宽阔原木'],
    [/^(.+) Bushy Logs$/, '$1 茂密原木'],
    [/^(.+) Dark Logs$/, '$1 黑色原木'],
